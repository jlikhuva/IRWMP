...
class greaterMonterey():
    ...
    def scrapeProposed(self):
        self.downloadConceptProposal()
        self.downloadProposedImplementationProjects()
        self.createConceptProposalDB()
        self.createProposedImplDB()

    def downloadConceptProposal(self):
        pass

    def downloadProposedImplementationProjects(self):
        pass

    def createConceptProposalDB(self):
        pass

    def createProposedImplDB(self):
        pass
